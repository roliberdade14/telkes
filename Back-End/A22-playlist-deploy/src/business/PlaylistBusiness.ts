...
import { LikeDislikeDB, PLAYLIST_LIKE, Playlist, PlaylistDB, PlaylistModel } from "../models/Playlist";
...
export class PlaylistBusiness {
  ...
  public getAllPlaylists = async (): Promise<PlaylistDB[]> => {

    const output = await this.playlistDatabase.getAllPlaylists()
