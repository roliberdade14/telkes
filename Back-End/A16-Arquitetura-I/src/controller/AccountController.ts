...
export class AccountController {
    ...
    public getAccounts = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const result: Account[] = await this.accountBusiness.getAccounts()
    ...
    public getAccountBalance = async (req: Request, res: Response): Promise<void> => {
        try {

            const id = req.params.id

            const resultBalance: number = await this.accountBusiness.getAccountBalance(id)
